...
class GridLabeller:
    ...
    def obtain_grid(self, prostate_centroid):
        ...
        """
        #TODO : check taht this is centred on prostate centre!!! ie x y z; insted of y x z
        grid_array = np.zeros((200,200))   
        grid_single_val = np.zeros((200,200))
        grid_debug = np.zeros((200,200))
        for i in range(-60, 65, 10):
            for j in range(-60, 65, 10):
                ...
                grid_debug[prostate_centroid[1] + j, prostate_centroid[1] +i] = 1
