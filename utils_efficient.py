#### 3D efficientnet
### Original source: https://github.com/shijianjian/EfficientNet-PyTorch-3D/blob/master/efficientnet_pytorch_3d/model.py 

# modifying functions to help with actor-critic networks 
"""
...
def efficientnet3d(width_coefficient=None, depth_coefficient=None, dropout_rate=0.2,
    ...
    blocks_args = [
        ...
        'r1_k3_s111_e6_i192_o112_se0.25', # changed o320 to o112
    ]
